<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Indus_footer.ascx.cs" Inherits="usercontrols_Indus_footer" %>
...
<img alt="Indus Image" src="images/srock.png" style="margin-left:-60px"   />
</div><!--strock-->
<div class="tours_locations" style="margin-top:-8px; ">
<div class="box1">
<h1>Inbound Tours</h1>
...
<img alt="Indus Image" src="images/dot.jpg"  style="margin-left:-12px;  float:left; position:relative; top:8px;"/><li><a href="#" style="color:#808080";>Air Ticketing</a></li>
<img alt="Indus Image" src="images/dot.jpg"  style="margin-left:-12px;  float:left; position:relative; top:8px;"/><li><a href="#" style="color:#808080";>Bus Reservations</a></li>
<img alt="Indus Image" src="images/dot.jpg"  style="margin-left:-12px;  float:left; position:relative; top:8px;"/><li><a href="#" style="color:#808080";>Foreign Exchange Transportation</a></li>
<img alt="Indus Image" src="images/dot.jpg"  style="margin-left:-12px;  float:left; position:relative; top:8px;"/><li><a href="#" style="color:#808080";>Guides & Interpreters</a></li>
<img alt="Indus Image" src="images/dot.jpg"  style="margin-left:-12px;  float:left; position:relative; top:8px;"/><li><a href="#" style="color:#808080";>Hotel Reservations</a></li>
</div>--%><!--box5-->
</div>
<div class="stock1" style="text-align:center" >
<img alt="Indus Image" src="images/srock.png" style="margin-left:-80px" class="imgs"  />
</div>
<div class="scrolling_flash2233" style="">
<div class="flash_left" style="clear:both; position:relative; ">
  <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="70" id="Object1" title="right_flash">
...
<div class="flash_right">
  <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="70" id="Object2" title="left_flash">
...
<!--strock-->
<div class="tours" style="margin-top:-5px;">
...
<%--<table>
<tr>
<td><asp:ImageButton ID="imgbottom1" runat="server" ImageUrl="~/industravels/images/BottomStrip/img_one.png" /></td>
<td><asp:ImageButton ID="imgbottom2" CssClass="mix" runat="server" ImageUrl="~/industravels/images/BottomStrip/img_one11.png" /></td>
<td><asp:ImageButton ID="imgbottom3" CssClass="mix" runat="server" ImageUrl="~/industravels/images/BottomStrip/img_two.png" /></td>
<td><asp:ImageButton ID="imgbottom4" CssClass="mix" runat="server" ImageUrl="~/industravels/images/BottomStrip/img_two22.png" /></td>
<td><asp:ImageButton ID="imgbottom5" CssClass="mix" runat="server" ImageUrl="~/industravels/images/BottomStrip/img_three.png" /></td>
<td><asp:ImageButton ID="imgbottom6" CssClass="mix" runat="server" ImageUrl="~/industravels/images/BottomStrip/img_three22.png" /> </td>
<td><asp:ImageButton ID="imgbottom7" CssClass="mix" runat="server" ImageUrl="~/industravels/images/BottomStrip/img_four.png" /></td>
<td><asp:ImageButton ID="imgbottom8" CssClass="mix" runat="server" ImageUrl="~/industravels/images/BottomStrip/img_four22.png" /></td>
</tr>
</table>--%>
</div><!--tours-->
<div class="footer1">
<p><a href="TimeZone.aspx">Time Zones</a> |<a href="AirlineNumbers.aspx"> Airlines Numbers</a> |<a href="currency.aspx"> Currency </a>| 
<a href="weather.aspx">Weather</a> |<a href="WeightConvertion.aspx"> Weight Conversion </a>| <a href="travelinsurence.aspx">Travel Insurance</a>
 |<a href="TermsConditions.aspx"> Terms & Conditions</a> |<a href="advertise.aspx"> Advertise</a> |<a href="faq.aspx"> FAQ</a> | <a href="RouteMap.aspx"> 
 Route Map</a> | <a href="SiteMap.aspx"> Site Map</a> |<a href="PrivacyPolicy.aspx"> Privacy Policy</a> | Copyright @ Indus Travels 1999-2014. Allrights</p>
</div><!--footer-->