 ...
 <script type="text/javascript">
      $(document).ready(function () {
          ...
          $("#addButton").click(function () {
              ...
              $('#tabadd tr:last').after('<tr ><td><input name="TextBoxs1" type="text" value="Select Origin" id="TextBoxs'+counter+
               '" style="background-color:#F6F6F6;height:30px;width:275px;" />'+
               '</td><td align="center">&#x21c4;</td><td><input name="TextBoxs2" type="text" value="Select Destination" id="TextBoxs2'+counter+
...
$('#txtBusDept').datepicker({
minDate: new Date(currentYear, currentMonth, currentDate)
});
$('#txtTrainDep').datepicker({
minDate: new Date(currentYear, currentMonth, currentDate)
});
});
</script>
...
<body >
 ...
 <%--<asp:ScriptManager ID="sccr1" runat="server"></asp:ScriptManager>--%>
...
<td >
 ...
 <asp:TextBox ID ="txtFrom" runat ="server" Height="30" Width="285" BackColor="#f6f6f6" onfocus="javascript:cleartext(this);"></asp:TextBox>
...
<td> <asp:TextBox ID ="txtTo" runat ="server" Height="30" Width="280" BackColor="#f6f6f6" onfocus="javascript:cleartext(this);"></asp:TextBox>
...
<td >
 ...
 <asp:TextBox ID ="txtinterfrm" runat ="server" Height="30" Width="285" BackColor="#f6f6f6" onfocus="javascript:cleartext(this);"></asp:TextBox>
...
<td> <asp:TextBox ID ="txtinterto" runat ="server" Height="30" Width="280" BackColor="#f6f6f6" onfocus="javascript:cleartext(this);"></asp:TextBox>
...
<tr >
<td > <asp:TextBox ID ="txt2from" runat ="server" Height="30" Width="275" BackColor="#f6f6f6" onfocus="javascript:cleartext(this);"></asp:TextBox>
...
<td> <asp:TextBox ID ="txt2to" runat ="server" Height="30" Width="270" BackColor="#f6f6f6" onfocus="javascript:cleartext(this);"></asp:TextBox>
...
--%> <asp:TextBox ID ="txtDepart" runat ="server" Height="25" Width="100" BackColor="#f6f6f6" ></asp:TextBox>
...
<td > 
<asp:TextBox ID ="txtReturn" runat ="server" Height="25" Width="100" BackColor="#f6f6f6"  ></asp:TextBox>
...
<div style="width:100%">
<asp:TextBox ID="txtHdoSer" runat="server" BackColor="#F6F6F6" Height="30" Width="500" onfocus="javascript:cleartext(this);"></asp:TextBox>
...
<div style="width:100%">
<asp:TextBox ID="txtInterhSer" runat="server" BackColor="#F6F6F6" Height="30" Width="500" onfocus="javascript:cleartext(this);"></asp:TextBox>
...
<tr>
<td>
<asp:TextBox ID ="txtHcin" runat ="server" Height="25" Width="150" BackColor="#f6f6f6"  ></asp:TextBox>
...
<td >
<asp:TextBox ID ="txtHcout" runat ="server" Height="25" Width="150" BackColor="#f6f6f6"  ></asp:TextBox>
...
<td valign="top">
<asp:Button ID ="btnHSearch" runat ="server" CssClass="butn22 marr"  Text="Search Hotel" />
...
<div style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#002073; margin-left:10px;
     ...
     <asp:TextBox ID="txtHoliday" runat="server" BackColor="#F6F6F6" Height="30" Width="500" onfocus="javascript:cleartext(this);"></asp:TextBox>
...
<asp:ListItem Value="3" Text=">7 Days"></asp:ListItem> 
     ...
     <td><asp:DropDownList ID="ddlMtravel" runat ="server" BackColor="#f6f6f6" Width="260" Height="32">
...
<asp:ListItem Value="3" Text="5 Star"></asp:ListItem> 
     ...
     <asp:Button ID ="btnHoliday" runat ="server" CssClass="butn22 marr"  Text="Search Holiday" />
...
<div style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#002073; margin-left:10px;
    ...
    Book the best bus for your journey. Choose from over 700 bus travel operators all over India and book your ticket.</p>
     ...
     <tr>
     <td> <asp:TextBox ID="txtBusfrom" runat="server" BackColor="#F6F6F6" Height="30" Width="270" onfocus="javascript:cleartext(this);"></asp:TextBox>
...
<td  align="left" width="15" style="color:Gray">&#x21c4;
     ...
     <td>
     <asp:TextBox ID="txtBusTo" runat="server" BackColor="#F6F6F6" Height="30" Width="270" onfocus="javascript:cleartext(this);"></asp:TextBox>
...
<ajax:AutoCompleteExtender ID="AutoCompleteExtender10" runat="server" CompletionInterval="1000" CompletionSetCount="1" 
  EnableCaching="true" MinimumPrefixLength="1" ServiceMethod="SearchBus" ShowOnlyCurrentWordInCompletionListItem="true"
   TargetControlID="txtBusTo" CompletionListCssClass="autobox">
     ...
     <asp:TextBox ID ="txtBusDept" runat ="server" Height="25" Width="150" BackColor="#f6f6f6"  ></asp:TextBox>
...
<div style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#002073; margin-left:10px;
     ...
     <tr>
     <td> <asp:TextBox ID="txtTrainFrom" runat="server" BackColor="#F6F6F6" Height="30" Width="270" onfocus="javascript:cleartext(this);"></asp:TextBox>
...
<td  align="left" style="color:Gray">&#x21c4;
     ...
     <td>
     <asp:TextBox ID="txtTrainTo" runat="server" BackColor="#F6F6F6" Height="30" Width="270" onfocus="javascript:cleartext(this);" ></asp:TextBox>
...
<asp:ListItem value="2S">2S - Second Sitting</asp:ListItem>
     ...
     <td>
     <asp:TextBox ID ="txtTrainDep" runat ="server" Height="25" Width="150" BackColor="#f6f6f6"  ></asp:TextBox>
 ...
 <div class="map_main_contianer">
               <div style=" margin-left:20px; margin-top:-30px; width:600px;">  
                ...
                <div class="map_contianer" style="margin-top:25px;">
                    <!-- Dots -->
                    <a id="ctl00_ContentPlaceHolder1_lnk_usa" class="dot5" continent="NA" city="USA" title="USA"
                     href="javascript:__doPostBack(&#39;ctl00$ContentPlaceHolder1$lnk_usa&#39;,&#39;&#39;)" style="top: 133px; left: 80px;"></a>
