<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SearchHotels.aspx.cs" Inherits="SearchHotels" %>
...
<title>::Indus Travels::Search-Hotel::</title>
...
<body>
   ...
   <div class="titlediv">
  <span class="spans"> &emsp; Hotels Informtion : &emsp;</span> <asp:Label ID="lbl1" runat="server" ForeColor="Red"></asp:Label>
  <hr style="border:1px dotted gray; width:99%" />
   </div>
   <table width="100%">
   <tr>
   <td>
